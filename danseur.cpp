...
danseur::danseur(int cin_p, string nom, string prenom, string nationamite, string date_naissance, string style_danse) : personnes(cin_p, nom, prenom, nationalite, date_naissance)
{
